...
//            static void getAuthInfo(C2DXPlatType platType);
             ...
             *	@param 	callback 	回调方法
             */
            static void oneKeyShareContent(int reqID, const C2DXPlatforms& platTypes, C2DXDictionary *content, C2DXShareResultEvent callback);
             ...
             *	@param 	callback 	回调方法
             */
            static void showShareMenu(int reqID, const C2DXPlatforms& platTypes, C2DXDictionary *content, C2DXPoint pt, C2DXShareResultEvent callback);
