...
void CCJSONConverter::convertJsonToArray(cJSON * json, CCArray * array)
{
    ...
    for (int i=0; i<size; i++) {
        ...
        CAObject * objItem = getJsonObj(jsonItem);
...
cJSON * CCJSONConverter::getObjJson(CAObject * obj)
{
...
CAObject * CCJSONConverter::getJsonObj(cJSON * json)
{
    switch (json->type) {
        case cJSON_Object:
        {
