...
#ifndef AppGift_ShareSDKTypeDef_h
#define AppGift_ShareSDKTypeDef_h
...
namespace cn
{
    namespace sharesdk
    {
         ...
         *	@brief	授权返回回调事件
         */
        typedef void(*C2DXAuthResultEvent) (C2DXResponseState state, C2DXPlatType platType, CSJsonDictionary& error);
        
        /**
         *	@brief	获取用户信息返回回调事件
         */
        typedef void(*C2DXGetUserInfoResultEvent) (C2DXResponseState state, C2DXPlatType platType, CSJsonDictionary& userInfo, CSJsonDictionary& error);
        
        /**
         *	@brief	分享返回回调事件
         */
        typedef void(*C2DXShareResultEvent) (C2DXResponseState state, C2DXPlatType platType, CSJsonDictionary& shareInfo, CSJsonDictionary& error);
    }
}
