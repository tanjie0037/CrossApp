...
namespace cn
{
    namespace sharesdk
    {
        ...
        public:
             ...
             *	@return 	reqID 	流水号
             */
            static int oneKeyShareContent(const C2DXPlatforms& platTypes, C2DXDictionary *content, C2DXShareResultEvent callback);
             ...
             *	@return 	reqID 	流水号
             */
            static int showShareMenu(const C2DXPlatforms& platTypes, C2DXDictionary *content, int x, int y, C2DXShareResultEvent callback);
